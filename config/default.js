module.exports = {
  ...
  apiEndpoints: {
    ...
    nuturePreferences: {
      preferenceNurture: {
        url: 'browsing/v1/historical_infos/quote_prices',
        host:  'BROWSING'
      },
      preferenceParams: {
        url: 'browsing/v1/requested_trips/t/:unique_key/:secret_key',
        host: 'BROWSING'
      },
      updateAlive: {
        url: 'browsing/v1/requested_trips/t/:unique_key/:secret_key/alive',
        host: 'BROWSING'
      },
    },
    animatedBanner: {
