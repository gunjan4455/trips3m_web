...
import { TESTIMONIALS_LOAD_SUCCESS, } from '../../actionConstants';
import { getCurrentMonth } from 'helpers/DateTime';
import { pdpFooterLinks } from 'helpers/urlHelpers';

const LOAD = 'package/details/LOAD';
const LOAD_SUCCESS = 'package/details/LOAD_SUCCESS';
const LOAD_FAIL = 'packages/details/LOAD_FAIL';
...
import {  FOOTER_LINKS_LOAD,
  FETCH_FOOTER_LINKS_SUCCESS,
  FETCH_FOOTER_LINKS_FAIL, } from 'screens/hlp/action';
...
export function packageDetails(globalState) {
  try {
    ...
    return {
      ...
      reviews: details.data.data.reviews,
      schemaAttributes: details.data.data.schema_attributes
    };
  } catch (e) {
    return null;
  }
