...
import BudgetSlider, { BudgetOptions, DefaultBudgetOptions, BudgetText } from './BudgetSlider';
...
describe('lead form module', () => {
  ...
  it('should render budgetText', () => {
    const wrapper = shallowWrapperBudgetSlider(props);
    expect(wrapper.find(BudgetText)).toHaveLength(1);
  });

  it('should call goBack properly when variation step is sequential form three', () => {
