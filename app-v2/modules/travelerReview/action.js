import { cityBlockTestimonials, pdpTestimonials } from 'helpers/urlHelpers';
...
export function fetchCityBlockTestimonials({ destination, queryParams }) {
  return {
    types: [
      TESTIMONIALS_LOAD,
    ...
    promise: client => client.get(cityBlockTestimonials(destination, queryParams), {
      hostType: config.apiEndpoints.cityBlockTestimonials.host
    }),
