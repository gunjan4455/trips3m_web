...
import { hotelSearch, updateHotelBookingDetails, updateHotelSearchParams } from '../hdp/action';
import { getHotelSearchDataObj, loadHotelDetails } from '../hdp/reducer';

const HotelReviewBooking = Loadable({
  loader: () => import(/* webpackChunkName: 'hotel-review-booking' */ './HotelReviewBooking'),
  loading: () => null
});
...
export default asyncConnect(
  [
    {
      promise: () => import('./HotelReviewBooking')
    },
    {
